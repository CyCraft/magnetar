...
export declare function deletePropActionFactory(moduleData: PlainObject, actionName: 'deleteProp', storeName: string, makeDataSnapshot?: any, restoreDataSnapshot?: any): PluginDeletePropAction;
